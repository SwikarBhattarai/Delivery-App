...
export const Icons = {
    ...
    home: require('../assets/icons/icons8-home-48.png'),
    bgFood: require('../assets/icons/bg-food.jpg'),
    location: require('../assets/icons/location.svg'),
    locationPointer: require('../assets/icons/map.png'),
    empty_cart: require('../assets/icons/empty_cart.png'),
    add_to_cart: require('../assets/icons/cart.png'),
